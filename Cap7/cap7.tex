...
\begin{enumerate}
    \item Preencha o formulário ``Folha de Registro do Documento'' no site do ITA (ita.br/posgrad/tese) e o envie preenchido para o endereço \texttt{doc.pt@ita.br} (as instruções de preenchimento estão no formulário).
...
O registro da dissertação/tese é de responsabilidade da Seção de Processos Técnicos da Divisão de Informação e Documentação (BIB-PT), conforme descrito no item 9.1 da NPA-ITA-011B:2023 \textit{Elaboração e controle de Publicações Técnico-Científicas do ITA}.